...
namespace Infos.Controllers
{
    public class InfoesController : Controller
    {
        ...
        {
            return View("Index", await _context.Info.Where( j => j.InfoName.Contains(SearchPhrase)).ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,InfoName,InfoDescription")] Info info)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,InfoName,InfoDescription")] Info info)
        {
            if (id != info.Id)
            {
                return NotFound();
